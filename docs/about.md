<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Sabeeh Danish" class="about-avatar" width="160" height="160" loading="lazy" oncontextmenu="return false;" draggable="false">
  <div class="about-header-content">
    <h1 class="title">Hey, it's Sabeeh!</h1>
    <div class="about-socials" style="display:flex;gap:1.25rem;align-items:center;flex-wrap:wrap;margin-top:0.5rem;">
  <a href="https://github.com/SabeehDanish" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/sabeehdanish/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:sabeehdanish06@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
